...
% rfactor = zeros(length(lat),length(lon),length(level));
% 
% for s=1:30    
...
save(strcat('/net/aimsir/archive1/mkohl/inversion/output/r_simulation_mode/rescale',list{tt},'/final/RHS_rhs_smooth0_rms4_geostrophic_day0560h00.mat'),'omega','omega_QG','rhs');
