...
if tf_resolution==1
u = movmean(movmean(u,11,1),11,2);
v = movmean(movmean(v,11,1),11,2);
T = movmean(movmean(T,11,1),11,2);
omega = movmean(movmean(omega,11,1),11,2);
end
...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/reanalysis/rms1em4_geostrophic_boundary_w_without_rescale_true_coarse_resolution.mat'),'omega','omega_QG','r','rhs','lat','err_rms');
...
% [k_500_new,spec_500_r_new] = Spectrum2(omega_QG(:,:,p500,t),lat,lon);
