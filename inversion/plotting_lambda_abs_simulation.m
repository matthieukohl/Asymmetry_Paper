...
%path = ['/net/graupel/archive1/users/mkohl/inversion/output/abs_mode_simulation/',list{tt},'/rms4_geostrophic_',low,'_day0560h00.mat'];
path = ['/net/graupel/archive1/users/mkohl/inversion/output/abs_mode_simulation/',list{tt},'/rms3_relative_error_geostrophic_',low,'_day0560h00.mat'];
...
pholder = Lambda_weighted(omega(11:26,:,1:strat_level(tt),:),lat);
...
%path = [path,'/rms1em5_geostrophic_boundary_',low,'_day',num2str(5*(28+jj)),'.mat'];
path = [path,'/rms1em3_relative_error_geostrophic_boundary_',low,'_day',num2str(5*(28+jj)),'.mat'];
...
lambda_omega = lambda_omega + Lambda_weighted(omega(11:26,:,1:strat_level(tt),:),lat);
...
lambda_omega_QG = lambda_omega_QG + Lambda_weighted(omega_QG(11:26,:,1:strat_level(tt),:),lat);
...
%save(['figures_paper/lambda_abs_',low,'_',averaging,'_rms1em5.mat'],'lambda_turb_omega','lambda_turb_omega_QG','lambda_turb_omega_QG_rhs',...
%    'lambda_mode_omega','lambda_mode_omega_QG','lambda_mode_omega_QG_rhs')

save(['figures_paper/lambda_abs_',low,'_',averaging,'_rms1em3_relative_error.mat'],'lambda_turb_omega','lambda_turb_omega_QG','lambda_turb_omega_QG_rhs',...
    'lambda_mode_omega','lambda_mode_omega_QG','lambda_mode_omega_QG_rhs')
