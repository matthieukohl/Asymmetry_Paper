...
path = '/net/graupel/archive1/users/mkohl/reanalysis/asymmetry_project/era5/u_v_temp_omega_spectrum_comparison_2days_for_all_months.nc';
...
%save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/reanalysis/rms1em4_boundary_w_without_rescale_whole_circumference_geostrophic_res_10_t78.mat'),'omega','omega_QG','r','rhs','lat','lon','err_rms');

save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/reanalysis/rms1em4_boundary_w_without_rescale_whole_circumference_geostrophic_res_6_2days_for_all_months.mat'),'omega','omega_QG','r','rhs','lat','lon','err_rms');
