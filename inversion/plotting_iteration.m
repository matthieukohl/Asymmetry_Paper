...
for s=1:10
 ...
 %sigma_new = (0.2*sigma_new+0.8*sigma_old)/(0.2+0.8);
...
%save(strcat('output/rescale_0.1/sigma/relax_mean/smooth_cross/Total_rhs_smooth0_sigma_smooth5.0_iter10_day',num2str(25*i),'.mat'),'omega','omega_QG','rhs','sigma','sigma_new','sigma_new_smoothed');

%end

% figure(1)
% plot(omega_QG(12,:,12,1)); hold on
% plot(omega(12,:,12,1))
% 
% figure(2)
% plot(sigma_new(12,:,12,1)); hold on
% plot(sigma_new_smoothed(12,:,12,1))
