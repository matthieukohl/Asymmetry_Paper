...
%level_indices = [5,7,8,9,10,11,13,15,17];
...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/r_simulation/rescale',list_end{tt},'/rms4_geostrophic_boundary_w0_day',num2str(25*i),'_2layer_alternative.mat'),'omega','omega_QG','rhs','err_rms','lat','level');
