...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/abs_mode_simulation/',list{tt},'/rms15_geostrophic_w_day0560h00_two_layer.mat'),'omega','omega_QG','r','rhs','lat');
end
toc
% figure(1)
