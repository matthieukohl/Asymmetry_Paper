...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/abs_simulation/',list{tt},'/rms1em4_geostrophic_boundary_w0_rhs_day',num2str(5*(28+i)),'.mat'),'omega','omega_QG','r','rhs','lat','err_rms');
end
