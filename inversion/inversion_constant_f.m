function [omega_adv, omega_diab] = inversion_constant_f(u,v,omega,T,r,sigma,f0,beta,level,Phi,phi,dphi,lambda,dlambda)
...
w_new = SIP_diagnostic(R, f0, Nlon, Nlat, length(level_place), phi, lambda, level_place, ...
