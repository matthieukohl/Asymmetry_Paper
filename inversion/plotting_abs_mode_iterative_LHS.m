...
%Calculate RHS at abs_0.4

path_temp = strcat('/disk7/mkohl/interpolation/output_abs_mode/',list{1},'/temp_day0560h00.nc');
path_u = strcat('/disk7/mkohl/interpolation/output_abs_mode/',list{1},'/ug_day0560h00.nc');
path_v = strcat('/disk7/mkohl/interpolation/output_abs_mode/',list{1},'/vg_day0560h00.nc');
...
[A, B, C, J, Qx, Qy, ...
    ...
    dT_dlambda, dT_dphi] = deal(zeros(length(event_latspan), length(event_lonspan), length(level), length(event_timespan)));
...
save(strcat('/net/aimsir/archive1/mkohl/inversion/output/abs_mode_simulation/',list{tt},'/final/LHS_rhs_smooth0_rms15_geostrophic_trial_day0560h00.mat'),'omega','omega_QG','r','rhs');
...
% 
% figure(3)
% contour(omega(:,:,10)); colorbar
% 
% figure(4)
% contour(omega_QG(:,:,10)); colorbar
% 
% figure(5)
% plot(omega(10,:,12)); hold on; plot(omega_QG(10,:,12))