...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/r_mode_simulation/rescale',list{tt},'/rms6_geostrophic_boundary_w_rhs_day0560h00.mat'),'omega','omega_QG','rhs','err_rms','lat');
