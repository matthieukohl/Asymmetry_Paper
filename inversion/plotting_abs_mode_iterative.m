...
%save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/abs_mode_simulation/',list{tt},'/rms8_geostrophic_w_day0560h00.mat'),'omega','omega_QG','r','rhs','lat');
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/abs_mode_simulation/',list{tt},'/rms3_relative_error_geostrophic_w_day0560h00.mat'),'omega','omega_QG','r','rhs','lat');
end
toc
% figure(1)
