...
[spec_av_r,spec_mid_r,spec_500_r] = deal(zeros(15,256));
...
figure(1)
semilogx(k(1:N/2),spec_500_r(end,1:N/2)); hold on;
ylabel('Magnitutde')
xlabel('Wavenumber k')
...
figure(2)
semilogx(surf_temp,k_500_r.*Ld); hold on;
semilogx(surf_temp,k_500_r.*0.5*1e6/sqrt(2));
xlabel('Tg')
...
subplot(1,2,1)
semilogx(k(1:N/2),spec_500_r(14,1:N/2)/max(spec_500_r(1,1:N/2))); hold on;
ylabel('Magnitutde')
xlabel('Wavenumber k')
title('Power spectrum w at 500hPa for abs4.0')

subplot(1,2,2)
semilogx(k(1:N/2),(k(1:N/2).^2+1).*spec_500_r(14,1:N/2)/(max((k(1:N/2).^2+1).*spec_500_r(1,1:N/2)))); hold on;
ylabel('Magnitutde')
xlabel('Wavenumber k')
title('$(k^2+1)$ Power spectrum w at 500hPa for abs4.0')
