...
%      
%      
%     sigma_new_smoothed(:,:,n,t)= imgaussfilt(sigma_new(:,:,n,t),3);
%     
% %     for i=1:2
% %         
...
save(strcat('output/rescale_0.1/sigma/relax_mean/smooth_cross/bc_zero/RHS_rhs_smooth0_sigma_iter10_day',num2str(25*i),'.mat'),'omega','omega_QG','rhs','sigma','sigma_new','sigma_new_smoothed');


end

figure(2)
plot(omega(15,:,6,1)); hold on
plot(omega_QG(15,:,12,1));

figure(3)
plot(sigma_new(15,:,6,1)); hold on;
plot(sigma_new_smoothed(15,:,6,1));
