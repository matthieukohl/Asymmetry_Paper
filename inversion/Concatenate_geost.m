...
for i=1:4
    ...
    s = load(strcat('output/rescale_0.1/sigma/equivalent_J/zero_BC/geostrophic/RHS_rhs_smooth0_iter10_day',num2str(25 * i),'.mat'));
...
for i=1:4
    ...
    t= load(strcat('output/rescale_0.1/sigma/equivalent_J/zero_BC/geostrophic/Total_rhs_smooth0_iter10_day',num2str(25 * i),'.mat'));
