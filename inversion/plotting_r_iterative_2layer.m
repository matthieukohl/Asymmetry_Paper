...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/r_simulation/rescale',list_end{tt},'/rms4_geostrophic_boundary_w_day',num2str(25*i),'_2layer.mat'),'omega','omega_QG','rhs','err_rms','lat','level');
