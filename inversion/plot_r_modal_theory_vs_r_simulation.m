...
load(['figures_paper/modal_theory_N200_L8pi_',IC,'_relative_error_1pm3.mat'])
...
subplot(1,2,1)
plot(x,w_final(:,ind)/max(w_final(:,ind)),'b','Linewidth',1.8);
xlabel('x');
...
saveas(gcf,'figures_paper/modal_asymmetry_and_w_profile_relative_error_1pm3','epsc');