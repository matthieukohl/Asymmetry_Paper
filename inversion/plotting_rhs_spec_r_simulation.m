...
[k_av_new,spec_av_new] = Spectrum2_weighted(rhs(:,:,plow:trop_new,t),lat,lon);
[k_mid_new,spec_mid_new] = Spectrum2_weighted(rhs(:,:,pmid,t),lat,lon);
[k_500_new,spec_500_new] = Spectrum2_weighted(rhs(:,:,p500,t),lat,lon);
[pholder,spec_500_new_vs_lat] = Spectrum2_vs_lat(rhs(:,:,p500,t),lat,lon);
...
save('figures_paper/k_rhs_spectrum_r_simulation_gcm.mat','k_500_r','Ld');
