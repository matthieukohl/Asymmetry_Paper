...
spec_w_current_T85 = spec_500_r(1,1:N/2);
spec_w_current_T85 = spec_w_current_T85/max(spec_w_current_T85);
spec_w_warm_T85 = spec_500_r(2,1:N/2);
spec_w_warm_T85 = spec_w_warm_T85/max(spec_w_warm_T85);
...
spec_w_current_T170 = spec_500_r(1,1:N/2);
spec_w_current_T170 = spec_w_current_T170/max(spec_w_current_T170);
spec_w_warm_T170 = spec_500_r(2,1:N/2);
spec_w_warm_T170 = spec_w_warm_T170/max(spec_w_warm_T170);


k_T170 = k(1:N/2);

figure(1)
semilogx(k_T85,spec_w_current_T85,'b'); hold on;
semilogx(k_T170,spec_w_current_T170,'b--'); hold on;
semilogx(k_T85,spec_w_warm_T85,'r'); hold on;
semilogx(k_T170,spec_w_warm_T170,'r--');
ylabel('Magnitutde')
xlabel('Wavenumber k')
title('Power spectrum w at 500hPa')
legend('Current T85','Current 170','Warm T85','Warm T170'); legend boxoff;

figure(2)
loglog(k_T85,spec_w_current_T85,'b'); hold on;
loglog(k_T170,spec_w_current_T170,'b--'); hold on;
loglog(k_T85,spec_w_warm_T85,'r'); hold on;
loglog(k_T170,spec_w_warm_T170,'r--');
ylabel('Magnitutde')
xlabel('Wavenumber k')
title('Power spectrum w at 500hPa')
legend('Current T85','Current 170','Warm T85','Warm T170'); legend boxoff;
