...
l1 = legend([h3,h4,h1,h2],{'GCM Mode','QG Mode','GCM Turb.','QG Turb.'},'Location','NorthEast','FontSize',10); legend boxoff
l1pos = get(l1,'position');
set(l1,'position',l1pos+[0.01 0.01 0 0]);
t1 = title('QG Inversion with r($\omega$)');
...
%ylabel('\lambda')
set(gca,'FontSize',11);
t2 = title('QG Inversion with r($\omega$)=1');
