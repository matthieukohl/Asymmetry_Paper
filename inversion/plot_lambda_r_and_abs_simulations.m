...
t1 = title('QG Inversion uses $\mathcal{R}(w)$');
...
%ylabel('\lambda')
set(gca,'FontSize',11);
t2 = title('QG Inversion uses $\mathcal{R}(w)$=1');
...
load(['figures_paper/lambda_abs_',low,'_',averaging,'_rms1em3_relative_error.mat'])
...
plot(surf_temp,lambda_mode_omega_QG,'r--','linewidth',1.2);
...
saveas(gcf,['figures_paper/lambda_qg_and_gcm_',low,'_',averaging,'_mathcalRw'],'epsc');