...
%while rms(diff(:))>=1*10^(-7) && count<100
...
save(strcat('/net/graupel/archive1/users/mkohl/inversion/output/abs_simulation/',list{tt},'/rms1em4_geostrophic_boundary_w_day_',num2str(5*(28+i)),'_2layer.mat'),'omega','omega_QG','r','rhs','lat','err_rms','level');
end
