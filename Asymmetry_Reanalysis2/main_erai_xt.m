...
if tf_hemisphere ==1
[lambda_erai_NH_xt] = deal(zeros(54,37,12));
else
[lambda_erai_SH_xt] = deal(zeros(54,37,12));
end
...
if tf_hemisphere ==1
lambda_erai_NH_xt(:,:,ii) = lambda;
else
lambda_erai_SH_xt(:,:,ii) = lambda; 
...
if tf_hemisphere ==1
 ...
 save('data_erai/asymmetry_erai_NH_xt.mat', ...
      'lambda_erai_NH_xt', 'lat', 'level')
  
else
   save('data_erai/asymmetry_erai_SH_xt.mat', ...
      'lambda_erai_SH_xt', 'lat', 'level')  
end
