...
if tf_hemisphere ==1
lambda_era5_NH_x(:,:,ii) = lambda;
else
lambda_era5_SH_x(:,:,ii) = lambda; 
end
...
if tf_hemisphere ==1
 ...
 save('data_era5/asymmetry_era5_NH_x.mat', ...
      'lambda_era5_NH_x', 'lat', 'level')
  
else
   save('data_era5/asymmetry_era5_SH_x.mat', ...
      'lambda_era5_SH_x', 'lat', 'level')  
end
