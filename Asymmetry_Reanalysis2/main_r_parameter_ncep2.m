...
[k_av_new,spec_av_new] = Spectrum1(omega(lat30:lat70,:,plow:trop_new),lat(lat30:lat70),lon);
[k_mid_new,spec_mid_new] = Spectrum1(omega(lat30:lat70,:,pmid),lat(lat30:lat70),lon);
[k_500_new,spec_500_new] = Spectrum1(omega(lat30:lat70,:,p500),lat(lat30:lat70),lon);
...
[S_mid_new,S_500_new,S_av_new] = Static_Stability(sigma_accu(lat30:lat70,:,:),level,trop_new);
...
[L_mid_new,L_500_new,L_av_new] = Deformation_Radius(sigma_accu(lat30:lat70,:,:),f,level,lat,trop_new);
...
[r_mid_new,r_500_new,r_av_new] = reduction_factor(r(lat30:lat70,:,:),level,trop_new);
...
%   
 ...
 save('data_theory/theory_ncep2_NH_april29th.mat', ...
      'lambda_NH_theory_mid','lambda_NH_theory_500','lambda_NH_theory_av',...
      'lambda_NH_modal_theory_500',...
  ...
  'trop_NH','S_500_NH','S_mid_NH','S_av_NH', 'lat', 'level')
   ...
   save('data_theory/theory_ncep2_SH_april29th.mat', ...
      'lambda_SH_theory_mid','lambda_SH_theory_500','lambda_SH_theory_av',...
  'lambda_SH_modal_theory_500',...   
