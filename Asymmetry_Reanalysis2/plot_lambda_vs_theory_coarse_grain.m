...
load('theory_reanalysis_k_adv_spec');
...
%h11 = plot(lambda_NH_theory_rhs,'linewidth',1.5,'Color','k','Linestyle',':'); hold on;
...
%h11 = plot(lambda_SH_theory_rhs,'linewidth',1.5,'Color','k','Linestyle',':'); hold on;
