...
lambda_NH_theory_fixed(ii) = toy_model_nondimensional(r_500_NH(ii),k_NH_500(1)*LD_NH_500(1)); 
lambda_SH_theory_fixed(ii) = toy_model_nondimensional(r_500_SH(ii),k_SH_500(1)*LD_SH_500(1));
...
h1 = plot(lambda_era5_NH_x_weighted,'linewidth',1.5,'Color','b'); hold on;
...
h1 = plot(lambda_era5_SH_x_weighted,'linewidth',1.5,'Color','b'); hold on;
...
saveas(gcf,'/net/aimsir/archive1/mkohl/inversion/figures_paper/lambda_seasonal_cycle_reanalysis_vs_theory_coarse_grain_x_mean','epsc');
...
saveas(gcf,'/net/aimsir/archive1/mkohl/inversion/figures_paper/r_and_k_seasonal_cycle_coarse_grained','epsc');
