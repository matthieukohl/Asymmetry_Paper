...
lambda_era5_NH_xy = squeeze(lambda_era5_NH_xy_wzm(p500,:));
...
lambda_era5_SH_xy = squeeze(lambda_era5_SH_xy_wzm(p500,:));
...
h2 = plot(lambda_era5_NH_xy,'r','Linewidth',1.5); hold on;
h3 = plot(lambda_era5_NH_xt,'b','linewidth',1.5); hold on;
...
l1 = legend([h1,h2,h3],{'x-average','xy-average','xt-average'},'Location','NorthWest'); legend boxoff
...
h2 = plot(lambda_era5_SH_xy,'r','Linewidth',1.5); hold on;
h3 = plot(lambda_era5_SH_xt,'b','linewidth',1.5); hold on;
