...
k_NH_rhs(ii) = sum(k(indx:end).*spec_NH_500(indx:end,ii)')./sum(spec_NH_500(indx:end,ii)');
k_SH_rhs(ii) = sum(k(indx:end).*spec_SH_500(indx:end,ii)')./sum(spec_NH_500(indx:end,ii)');
