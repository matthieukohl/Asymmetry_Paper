...
legend('NCEP2','ERAI','ERA5','Location','SouthWest'); legend boxoff;
set(gca,'xtick',1:12,...
...
plot(r_500_SH_era5,'b','Linewidth',1.5); hold on;
legend('NCEP2','ERAI','ERA5','Location','SouthWest'); legend boxoff;
set(gca,'xtick',1:12,...
 'xticklabel',{'Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'})
set(gca,'Fontsize',12)
...
subplot(1,2,1)
plot(k_500_NH_era5,'b','Linewidth',1.5); hold on;
plot(k_500_NH_erai,'r','Linewidth',1.5); hold on;
plot(k_500_NH_ncep2,'g','Linewidth',1.5); hold on;
legend('ERA5','ERAI','NCEP2','Location','West'); legend boxoff;
set(gca,'xtick',1:12,...
 'xticklabel',{'Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'})
set(gca,'Fontsize',12)
set(gca,'box','off')
...
subplot(1,2,2)
plot(k_500_SH_era5,'b','Linewidth',1.5); hold on;
...
plot(lambda_era5_NH_theory,'b--','Linewidth',1.5); hold on;
...
legend('ERA5 Theory','ERAI Theory','NCEP2 Theory','ERA5','ERAI','NCEP2','Location','NorthWest'); legend boxoff;
set(gca,'xtick',1:12,...
 'xticklabel',{'Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'})
set(gca,'Fontsize',12)
set(gca,'box','off')
ylabel('Asymmetry parameter $\lambda$')
title('Northern Hemisphere 2d')
ylim([0.5 0.85])

subplot(1,2,2)
plot(lambda_era5_SH_theory,'b--','Linewidth',1.5); hold on;
plot(lambda_erai_SH_theory,'r--','Linewidth',1.5); hold on;
plot(lambda_ncep2_SH_theory,'g--','Linewidth',1.5); hold on;
plot(lambda_era5_SH_x,'b','Linewidth',1.5); hold on;
...
% plot(lambda_ncep2_NH_theory,'g--','Linewidth',1.5); hold on;
% plot(lambda_ncep2_NH_x,'g','Linewidth',1.5); hold on;
% legend('ERA5','ERA5 Theory','ERAI Theory','ERAI','NCEP2 Theory','NCEP2','Location','NorthWest'); legend boxoff;
% set(gca,'xtick',1:12,...
%  'xticklabel',{'Jan','Feb','Mar','Apr','May','Jun','Jul','Aug','Sep','Oct','Nov','Dec'})
% set(gca,'Fontsize',12)
% set(gca,'box','off')
