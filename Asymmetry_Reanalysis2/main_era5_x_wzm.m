...
if tf_hemisphere ==1
[lambda_era5_NH_x_wzm] = deal(zeros(161,37,12));
else
[lambda_era5_SH_x_wzm] = deal(zeros(161,37,12));
end
...
if tf_hemisphere ==1
lambda_era5_NH_x_wzm(:,:,ii) = lambda;
else
lambda_era5_SH_x_wzm(:,:,ii) = lambda; 
end
...
if tf_hemisphere ==1
 ...
 save('data_era5/asymmetry_era5_NH_x_wzm.mat', ...
      'lambda_era5_NH_x_wzm', 'lat', 'level')
  
else
   save('data_era5/asymmetry_era5_SH_x_wzm.mat', ...
      'lambda_era5_SH_x_wzm', 'lat', 'level')  
end
