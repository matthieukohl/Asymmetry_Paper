...
if tf_hemisphere ==1
[lambda_era5_NH_xt_wzm] = deal(zeros(161,37,12));
else
[lambda_era5_SH_xt_wzm] = deal(zeros(161,37,12));
end
tic
...
if tf_hemisphere ==1
lambda_era5_NH_xt_wzm(:,:,ii) = lambda;
else
lambda_era5_SH_xt_wzm(:,:,ii) = lambda; 
...
if tf_hemisphere ==1
 ...
 save('data_era5/asymmetry_era5_NH_xt_wzm.mat', ...
      'lambda_era5_NH_xt_wzm', 'lat', 'level')
  
else
   save('data_era5/asymmetry_era5_SH_xt_wzm.mat', ...
      'lambda_era5_SH_xt_wzm', 'lat', 'level')  
end
