...
if tf_hemisphere ==1
[lambda_erai_NH_x] = deal(zeros(54,37,12));
else
[lambda_erai_SH_x] = deal(zeros(54,37,12));
end
...
if tf_hemisphere ==1
lambda_erai_NH_x(:,:,ii) = lambda;
else
lambda_erai_SH_x(:,:,ii) = lambda; 
end
...
if tf_hemisphere ==1
 ...
 save('data_erai/asymmetry_erai_NH_x.mat', ...
      'lambda_erai_NH_x', 'lat', 'level')
  
else
   save('data_erai/asymmetry_erai_SH_x.mat', ...
      'lambda_erai_SH_x', 'lat', 'level')  
end
