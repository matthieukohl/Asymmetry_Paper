function [asymmetry_parameter] = toy_model_randn(R,alpha)
...
%  end
% 
% E = rms(d_2x(N,dx)*(r.*w_new)-w_new-RHS);
...
% if k ==1 
%     if ismember(r,[0.01,0.1,0.5,1.0])
% figure(1)
% plot(w_final,'linewidth',1.2); hold on;
% ylabel('w')
%     end
% end
% legend('r=0.01','r=0.1','r=0.5','r=1','Location','NorthWest')
% legend boxoff
% set(gca,'box','off')
% saveas(gcf,['figures_paper/w_toy'],'epsc');
