...
h1 = plot(lambda_ncep2_NH_xy,'g','Linewidth',1.5); hold on
...
h2 = plot(lambda_erai_NH_xy,'r','Linewidth',1.5); hold on;
...
h3 = plot(lambda_era5_NH_xy,'b--','linewidth',1.5); hold on;
...
h5 = plot(lambda_era5_NH_xy_coarse_1p25_res,'b','linewidth',1.5); hold on;
...
h1 = plot(lambda_ncep2_SH_xy,'g','Linewidth',1.5); hold on
...
h2 = plot(lambda_erai_SH_xy,'r','Linewidth',1.5); hold on;
...
h3 = plot(lambda_era5_SH_xy,'b--','linewidth',1.5); hold on;
...
h5 = plot(lambda_era5_SH_xy_coarse_1p25_res,'b','linewidth',1.5); hold on;
...
saveas(gcf,'/net/aimsir/archive1/mkohl/inversion/figures_paper/lambda_seasonal_vs_reanalysis_xy_mean','epsc');
