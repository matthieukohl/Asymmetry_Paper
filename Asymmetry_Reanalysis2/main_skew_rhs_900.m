...
path_rhs = '/net/aimsir/archive1/mkohl/era_interim/Asymmetry_Project/era5/rhs_2009_2009_NH.nc';
...
years = 2009:1:2009; % goes to 2018
...
timespan = season_selector(path_rhs, month{kk}, years(tt), years(tt));
...
[a,ind40] = min(abs(lat-40));
[a,ind60] = min(abs(lat-60));

skew_rhs_new = Skewness(-rhs(ind40:ind60,:,t)); %Skewness function includes minus sign (since writte for omega fields)
skew_rhs_45_new = skewness(rhs(ind45,:,t));
